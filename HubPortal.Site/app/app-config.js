(function () {
    ...
    //app.constant("ELASTIC_SEARCH", "http://localhost:9200/checkpoint/_search"); // Local ES instance

    app.constant("ELASTIC_SEARCH", "https://search-hubportal-test-3ag2xfrjvpj2xs4tn37tz7fwnq.us-east-1.es.amazonaws.com/checkpointtest/_search"); // AWs ES sandbox instance
